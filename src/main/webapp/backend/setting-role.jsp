            ...
            <div class="card-header">
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-sm-6 col-md-4 mb-3 mb-sm-0">
                        <form action="list_roles" method="get">
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                            ...
                            <tr>
                                <th>
                                    <a class="d-flex align-items-center" href="edit_role?id=${roles.id}">
                                        <div class="ml-3">
                                            <span class="h5 text-hover-primary">${roles.name}</span>
                                        </div>
                                    </a>
                                </th>
                                <td>
                                    <span class="d-block font-size-sm text-body">${roles.description}</span>
                                </td>
                                <td>
                    ...
                    <c:if test="${not empty result}">
                        <c:forEach var="roles" items="${result}">
                            <tr>
                                <th>
                                    <a class="d-flex align-items-center" href="edit_role?id=${roles.id}">
                                        <div class="ml-3">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination float-right">
                            <li class="${currentPage > 1 ? 'page-item' : 'page-item disabled'}">
                                <a class="page-link"
                                   href="list_roles?pageNumber=${currentPage - 1}&keyword=${keyword}">Trước</a>
                            </li>
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                <li class="${currentPage != i ? 'page-item' : 'page-item active'}">
                                    <a class="page-link"
                                       href="list_roles?pageNumber=${i}&keyword=${keyword}">${i}</a>
                                </li>
                            </c:forEach>
                            <li class="${currentPage < totalPages ? 'page-item' : 'page-item disabled'}">
                                <a class="page-link"
                                   href="list_roles?pageNumber=${currentPage + 1}&keyword=${keyword}">Sau</a>
                            </li>
                        </ul>
                    </nav>
                </div>
