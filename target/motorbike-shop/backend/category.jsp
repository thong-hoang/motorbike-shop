                ...
                <table id="datatable"
                    ...
                    <c:if test="${empty result}">
                        <c:forEach var="categories" items="${listCategories}">
                            <tr>
                                <td>
                                    <span class="d-block">${categories.name}</span>
                                </td>
                                <td>
                                    <span class="d-block">${categories.alias}</span>
                                </td>
                                <td>
                                    <c:if test="${categories.enabled}">
                                        <a class="fas fa-check-circle fa-2x icon-green"
                                           href="enable_category?enabled=false&id=${categories.id}"
                                           title="Vô hiệu hoá">
                                        </a>
                                    </c:if>
                                    <c:if test="${!categories.enabled}">
                                        <a class="fas fa-check-circle fa-2x icon-gray"
                                           href="enable_category?enabled=true&id=${categories.id}" title="Kích hoạt">
                                        </a>
                                    </c:if>
                                </td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-sm btn-white" href="edit_category?id=${categories.id}">
                    ...
                    <c:if test="${not empty result}">
                        <c:forEach var="categories" items="${result}">
                            <tr>
                                <td>
                                    <span class="d-block">${categories.name}</span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <c:if test="${!categories.enabled}">
                                        <a class="fas fa-check-circle fa-2x icon-gray"
                                           href="enable_category?enabled=true&id=${categories.id}"
                                           title="Kích hoạt">
                                        </a>
                                    </c:if>
                                </td>
...
<script type="text/javascript">
    ...
    function showDeleteConfirmModal(link) {
        ...
        $("#confirmText").text("Bạn có muốn xoá thể loại này không ?");
        $("#confirmModal").modal();
    }
